\section{SMCQL}
SMCQL \cite{bater} is secure multiparty computation framework that is based on JAVA 8 and designed to execute database queries that are very similar so SQL. SMCQL currently only supports two parties and was released in 2017.
\subsection{Features}

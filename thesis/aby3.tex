...
Similar to the SQL-union the aby3-union does row-concatenation of two tables.  \todo[fancyline]{union und andere oparatioren die von standart sql abweichen beschreiben}

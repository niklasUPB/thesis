...
\section{Conclusion}
 In our work we have implemented several different use cases for the secure multiparty compuation frameworks ABY3, SMCQL, Conclave. We had to overcome problems like missing documentation and complex installation procedures. However, we were able to overcome them. 
 In particular, the reason for problems like lack of documentation is not inherent properties of multiparty compuation, but limited time and resources of the framework authors. From the frameworks we   
